...
internal static class Tokenizer
{
    ...
    [
        ...
        new OpeningBdiTokenParser(),
        new ClosingBdiTokenParser(),
        new OpeningBdoTokenParser(),
        new ClosingBdoTokenParser(),
        new OpeningBigTokenParser(),
        new ClosingBigTokenParser(),
        new OpeningBlockQuoteTokenParser(),
        new ClosingBlockQuoteTokenParser(),
